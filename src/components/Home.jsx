...
export const Home = () => {
  return (
    <div id="home">
      ...
      <p>I am a brazilian <span>front-end developer</span>, with a background in design and a keen eye for digital solutions, based in Salvador, Brazil. <a href="mailto:tuliopxavier@gmail.com">Let's talk</a>.</p>
